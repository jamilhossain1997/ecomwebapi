        ...
        <>
            ...
            <ul class="metismenu" id="menu">
                <li>
                    ...
                    <ul>
                        <li> <Link to="/"><i class="bx bx-right-arrow-alt"></i>Home</Link>
                        </li>
                        <li> <a href="index.html"><i class="bx bx-right-arrow-alt"></i>Contact</a>
                        </li>
                        <li> <Link to='/addperson'><i class="bx bx-right-arrow-alt"></i>Add Person</Link>
                        </li>
                ...
                <li>
                    <a href="https://creatantech.com/demos/codervent/syndron/documentation/index.html" target="_blank">
